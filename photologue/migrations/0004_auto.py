...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field viewers on 'Gallery'
        db.create_table('photologue_gallery_viewers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gallery', models.ForeignKey(orm['photologue.gallery'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('photologue_gallery_viewers', ['gallery_id', 'user_id'])

    def backwards(self, orm):
        # Removing M2M table for field viewers on 'Gallery'
        db.delete_table('photologue_gallery_viewers')
