...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GalleryUpload.tags'
        db.alter_column('photologue_galleryupload', 'tags', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'GalleryUpload.tags'
        db.alter_column('photologue_galleryupload', 'tags', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
