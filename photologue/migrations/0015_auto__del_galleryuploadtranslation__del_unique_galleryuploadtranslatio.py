...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageOverride.image'
        db.alter_column('photologue_imageoverride', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ImageOverride.image'
        raise RuntimeError("Cannot reverse this migration. 'ImageOverride.image' and its values cannot be restored.")
