...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PhotoTranslation', fields ['title_slug']
        db.delete_unique('photologue_photo_translation', ['title_slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'PhotoTranslation', fields ['title_slug']
        db.create_unique('photologue_photo_translation', ['title_slug'])
