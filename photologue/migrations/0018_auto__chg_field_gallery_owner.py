...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gallery.owner'
        db.alter_column('photologue_gallery', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Gallery.owner'
        db.alter_column('photologue_gallery', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': "orm['auth.User']"}),
