...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PhotoTranslation', fields ['title']
        db.delete_unique('photologue_photo_translation', ['title'])


    def backwards(self, orm):
        # Adding unique constraint on 'PhotoTranslation', fields ['title']
        db.create_unique('photologue_photo_translation', ['title'])
